...
<div class="form-group">
  <form name="formListaEquipamento2" id="formListaEquipamento2" method="post" action="{{url("criarAdicionarO")}}">
    @csrf
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          ...
          <form name="formListaEquipamentoRemov" id="formListaEquipamentoRemov" method="post" action="{{url("removerO")}}">
            @csrf
            <input type="hidden" name="id_personagem" id="id_personagem" value="{{$personagem->id}}" />
